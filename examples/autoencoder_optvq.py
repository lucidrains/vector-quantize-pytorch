...
'''
If you want to use OptVQ (quantization with optimal transport), you need to set `optimal_transport` to True,
else you can use the original VQ by setting `optimal_transport` to False.
'''
